      ...
      <section id="pricing" className="py-24 px-8 relative" style={{ background: "var(--surface-bg)" }}>
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 items-stretch">
              ...
              header={
                <div>
                  ...
                  <div className="flex items-baseline gap-1 mt-2">
                    <span className="text-4xl font-black text-white" style={{ fontFamily: "var(--font-mono)" }}>₹0</span>
            ...
            <BlobCard
              headerHeight={215}
              cardClassName="bg-[#0F1520] border-purple-500/40 shadow-2xl shadow-purple-500/20 ring-1 ring-purple-500/30"
              ...
              header={
                <div>
                  <div className="flex items-center justify-between mb-3">
                    <span className="inline-block px-3 py-1 rounded-full text-[11px] font-bold uppercase tracking-wider text-purple-300 bg-purple-500/15 border border-purple-500/30" style={{ fontFamily: "var(--font-mono)" }}>
                      CAMPUS EDITION
                    </span>
                  ...
                  <h3 className="text-2xl font-extrabold text-white">Institutional Pro</h3>
                  <div className="flex items-baseline gap-1 mt-2">
                    <span className="text-4xl font-black text-white" style={{ fontFamily: "var(--font-mono)" }}>₹499</span>
                    <span className="text-xs font-semibold text-slate-400">/ student / year</span>
                  </div>
                </div>
              }
            >
              <div className="space-y-6 flex-1 flex flex-col justify-between">
                <div>
                  ...
                  <div className="space-y-3 pt-4 mt-4 border-t border-white/10">
                    <div className="text-[11px] font-bold uppercase tracking-wider text-purple-400" style={{ fontFamily: "var(--font-mono)" }}>EVERYTHING IN STARTER PLUS:</div>
                    {[
                      ...
                      <div key={f} className="flex items-center gap-2.5 text-xs font-medium text-slate-200">
                        <span className="w-4 h-4 rounded-full flex items-center justify-center text-[10px] text-purple-300 bg-purple-500/25 font-bold shrink-0">✓</span>
                        <span>{f}</span>
                      </div>
                    ))}
                  </div>
                ...
                <Link
                  to="/register"
                  className="w-full flex items-center justify-center gap-2 py-3.5 rounded-xl text-sm font-bold text-white shadow-lg shadow-purple-500/25 bg-gradient-to-r from-purple-600 to-pink-500 hover:opacity-95 transition-all hover:scale-[1.01] active:scale-[0.99]"
                >
                  Deploy Campus Plan
                </Link>
              </div>
            ...
            <BlobCard
              headerHeight={200}
              cardClassName="bg-[#0F1520] border-amber-500/30 shadow-2xl shadow-amber-500/10"
              ...
              header={
                <div>
                  <div className="inline-block px-3 py-1 rounded-full text-[11px] font-bold uppercase tracking-wider mb-3 text-amber-300 bg-amber-500/15 border border-amber-500/30" style={{ fontFamily: "var(--font-mono)" }}>
                    GLOBAL SAAS & NETWORKS
                  </div>
                  <h3 className="text-2xl font-extrabold text-white">Enterprise Network</h3>
                  <div className="flex items-baseline gap-1 mt-2">
                    <span className="text-4xl font-black text-white" style={{ fontFamily: "var(--font-mono)" }}>Custom</span>
                    <span className="text-xs font-semibold text-slate-400">/ multi-campus</span>
                  </div>
                </div>
              }
            >
              <div className="space-y-6 flex-1 flex flex-col justify-between">
                <div>
                  ...
                  <div className="space-y-3 pt-4 mt-4 border-t border-white/10">
                    <div className="text-[11px] font-bold uppercase tracking-wider text-amber-400" style={{ fontFamily: "var(--font-mono)" }}>ENTERPRISE POWERS:</div>
                    {[
                      ...
                      <div key={f} className="flex items-center gap-2.5 text-xs font-medium text-slate-200">
                        <span className="w-4 h-4 rounded-full flex items-center justify-center text-[10px] text-amber-400 bg-amber-500/25 font-bold shrink-0">✓</span>
                        <span>{f}</span>
                      </div>
                    ))}
                  </div>
                ...
                <a
                  href="#contact"
                  className="w-full flex items-center justify-center gap-2 py-3.5 rounded-xl text-sm font-bold text-amber-300 bg-amber-500/20 hover:bg-amber-500/30 border border-amber-500/40 shadow-lg shadow-amber-500/20 transition-all hover:scale-[1.01] active:scale-[0.99]"
                >
